  ...
  return (
          ...
          <div className="relative bg-white shadow-3xl rounded-xl sm:w-6/12  md:w-6/12 lg:w-6/12 xl:w-8/12 2xl:w-4/12">
            ...
            <form onSubmit={handleSubmit} className="p-12 pt-0 md:p-18 rounded-xl flex flex-col">
              ...
              <Link className='flex self-center gap-x-2 mt-5 px-2 inline-block text-sm  no-underline' to={AuthRoutes.Register}>
                      {t('login.dont have an account')}<span className='text-blue-600'>{t('login.register here')}</span>
              </Link>
            </form>
          </div>
          </Container>
