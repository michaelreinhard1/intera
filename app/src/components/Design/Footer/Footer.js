...
const Footer = ({logo, alt, sections, companyName}) => {

  return (
    <Container className={'relative'}>
    <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800 w-full mt-40">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href={HomeRoutes.Index} className="flex items-center">
